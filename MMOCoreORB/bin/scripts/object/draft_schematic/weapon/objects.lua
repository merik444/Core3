...
object_draft_schematic_weapon_shared_punch_dagger = SharedDraftSchematicObjectTemplate:new {
	clientTemplateFileName = "object/draft_schematic/weapon/shared_punch_dagger.iff"
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "",
	arrangementDescriptorFilename = "abstract/slot/arrangement/arrangement_datapad.iff",
...
ObjectTemplates:addClientTemplate(object_draft_schematic_weapon_shared_punch_dagger, "object/draft_schematic/weapon/shared_punch_dagger.iff")
