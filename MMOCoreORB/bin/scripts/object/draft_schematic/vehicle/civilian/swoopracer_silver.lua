...
object_draft_schematic_vehicle_civilian_swoopracer_silver = object_draft_schematic_vehicle_civilian_shared_swoopracer_silver:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Swoopracer silver",
	...
	targetTemplate = "object/tangible/deed/vehicle_deed/swoopracer_silver_deed.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_vehicle_civilian_swoopracer_silver, "object/draft_schematic/vehicle/civilian/swoopracer_silver.iff")
