...
object_draft_schematic_vehicle_civilian_swoopracer_red = object_draft_schematic_vehicle_civilian_shared_swoopracer_red:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Swoopracer red",
	...
	targetTemplate = "object/tangible/deed/vehicle_deed/swoopracer_red_deed.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_vehicle_civilian_swoopracer_red, "object/draft_schematic/vehicle/civilian/swoopracer_red.iff")
