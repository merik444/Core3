...
object_draft_schematic_vehicle_civilian_swoopracer_black = object_draft_schematic_vehicle_civilian_shared_swoopracer_black:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Swoopracer Black",
	...
	targetTemplate = "object/tangible/deed/vehicle_deed/swoopracer_black_deed.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_vehicle_civilian_swoopracer_black, "object/draft_schematic/vehicle/civilian/swoopracer_black.iff")
