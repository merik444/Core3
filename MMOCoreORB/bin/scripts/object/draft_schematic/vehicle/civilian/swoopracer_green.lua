...
object_draft_schematic_vehicle_civilian_swoopracer_green = object_draft_schematic_vehicle_civilian_shared_swoopracer_green:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Swoopracer green",
	...
	targetTemplate = "object/tangible/deed/vehicle_deed/swoopracer_green_deed.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_vehicle_civilian_swoopracer_green, "object/draft_schematic/vehicle/civilian/swoopracer_green.iff")
