...
object_draft_schematic_vehicle_civilian_swoopracer_blue = object_draft_schematic_vehicle_civilian_shared_swoopracer_blue:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Swoopracer blue",
	...
	targetTemplate = "object/tangible/deed/vehicle_deed/swoopracer_blue_deed.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_vehicle_civilian_swoopracer_blue, "object/draft_schematic/vehicle/civilian/swoopracer_blue.iff")
